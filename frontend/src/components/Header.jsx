...
const navItemsInfo = [
  { name: "Home", type: "link", href: "/" },
  {
    ...
    items: [
      ...
      { title: "V Coach", href: "/vcoach"},
      { title: "Nutrify", href: "/nutrify"},
...
const NavItem = ({ item }) => {
  ...
  return (
    <li className="relative group">
      {item.type === "link" ? (
        <>
          <Link to={item.href} className="px-4 py-2 text-blue-500">
            {item.name}
          </Link>
        ...
        <div className="flex flex-col items-center">
          <button
            className="px-4 py-2 flex gap-x-1 items-center text-blue-500"
          ...
          >
            <ul className="bg-gray-800 text-center flex flex-col shadow-lg rounded-lg overflow-hidden">
  ...
  return (
    <section className="sticky top-0 left-0 right-0 z-50 bg-black">
      <header className="container mx-auto px-5 flex justify-between py-4 items-center">
        <Link to="/">
        <span class="text-white  text-4xl">Fit</span>
        <span class="text-blue-500 font-extrabold text-4xl italic">Boost</span>
